...
| `DEPLOY_PATH` | `/var/www/deepayv1.001` | Absolute path to the repository on the server |
...
`manifest.json` lives at the **repository root** (`/var/www/deepayv1.001/manifest.json`).
